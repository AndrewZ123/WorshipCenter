...
export const DEMO_TASKS: ServiceTask[] = [
  ...
  { id: 'task-3-1', service_id: 'svc-3', church_id: DEMO_CHURCH.id, template_id: null, title: 'Setup sound system', notes: 'Arrive 30 min early', assigned_team_member_id: 'tm-7', assigned_role: 'Sound Tech', position: 0, status: 'done', priority: 'high', due_date: null, depends_on_task_id: null, completed_at: new Date(Date.now() - 30 * 60 * 1000).toISOString(), completed_by: 'demo-user-1', due_offset_minutes: -30, created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
  { id: 'task-3-2', service_id: 'svc-3', church_id: DEMO_CHURCH.id, template_id: null, title: 'Test in-ear monitors', notes: '', assigned_team_member_id: 'tm-7', assigned_role: 'Sound Tech', position: 1, status: 'in_progress', priority: 'medium', due_date: null, depends_on_task_id: 'task-3-1', completed_at: null, completed_by: null, due_offset_minutes: -15, created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
  { id: 'task-3-3', service_id: 'svc-3', church_id: DEMO_CHURCH.id, template_id: null, title: 'Prepare baptism pool', notes: 'Fill and heat to 85°F', assigned_team_member_id: null, assigned_role: null, position: 2, status: 'pending', priority: 'urgent', due_date: null, depends_on_task_id: null, completed_at: null, completed_by: null, due_offset_minutes: -60, created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
  { id: 'task-3-4', service_id: 'svc-3', church_id: DEMO_CHURCH.id, template_id: null, title: 'Print bulletins', notes: '', assigned_team_member_id: null, assigned_role: null, position: 3, status: 'done', priority: 'low', due_date: null, depends_on_task_id: null, completed_at: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(), completed_by: 'demo-user-1', due_offset_minutes: -120, created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
  { id: 'task-3-5', service_id: 'svc-3', church_id: DEMO_CHURCH.id, template_id: null, title: 'Teardown and pack up gear', notes: 'Return mics to cabinet', assigned_team_member_id: null, assigned_role: 'Sound Tech', position: 4, status: 'pending', priority: 'medium', due_date: null, depends_on_task_id: null, completed_at: null, completed_by: null, due_offset_minutes: 30, created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },

  // Service 4 (next Sunday - draft) tasks
  { id: 'task-4-1', service_id: 'svc-4', church_id: DEMO_CHURCH.id, template_id: null, title: 'Confirm rehearsal time with team', notes: '', assigned_team_member_id: 'tm-1', assigned_role: 'Worship Leader', position: 0, status: 'pending', priority: 'high', due_date: null, depends_on_task_id: null, completed_at: null, completed_by: null, due_offset_minutes: null, created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
];
