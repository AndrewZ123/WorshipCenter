  ...
  return (
    <Box>
      <Flex justify="space-between" align={{ base: 'flex-start', md: 'center' }} mb="4" flexWrap="wrap" gap="2">
        <Box>
          <Text fontSize="lg" fontWeight="600" color={textColor}>Serve</Text>
          <Text mt="0.5" fontSize="sm" color={subtextColor}>
        ...
        <Center py="12">
          <VStack spacing="3">
            ...
            <Text fontSize="sm" color={subtextColor} textAlign="center" maxW="400px">
              Check back later for open positions to sign up for.
            </Text>
          </VStack>
        </Center>
      ) : (
