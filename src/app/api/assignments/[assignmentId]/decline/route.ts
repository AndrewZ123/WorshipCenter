...
import { sendDeclinationNotification } from '@/lib/notifications';
...
export async function POST(
  ...
  try {
    ...
    const declinedAssignment = await db.assignments.decline(assignmentId, userData.church_id);
    ...
    if (service) {
      // Notify leaders about the decline
      ...
      for (const leader of leaders) {
        ...
        await sendDeclinationNotification({
